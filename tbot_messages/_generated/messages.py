...
class MessageDescriptor:
    ...
    def get_keyboard_markup(self, locale, format_map=None):
        ...
        for current_row in range(rows):
            ...
            for button_model in row_buttons_models:
                ...
                if (callback_data is not None and 'None' not in
                        callback_data) or url is not None or \
                        switch_current_pm is not None:
                    row_buttons_objects.append(
    ...
    def send_if_active(
            ...
            set_state: str = None, format_keyboard_map: dict = None,
            format_map: dict = None, photo=None, video=None, **kwargs
    ):
        ...
        markup = custom_markup if custom_markup is not False else \
            self.get_keyboard_markup(locale, format_keyboard_map)
        try:
            if photo:
